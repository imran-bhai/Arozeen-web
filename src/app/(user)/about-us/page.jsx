    ...
    <>
      <MaxWidthWrapper>
        <div className="w-[70%] m-auto">
          ...
          <p className="">
            Welcome to Arozeen.com – your go-to destination for quality products
            and hassle-free shopping. We keep it simple: great products, fair
            prices, and a commitment to your satisfaction.
          </p>
