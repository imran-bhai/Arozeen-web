...
const ShopCollection = () => {
  return (
    ...
    <MaxWidthWrapper className="flex flex-col justify-center items-center md:items-center lg:items-start">
      <h3 className="text-primary font-semibold text-2xl sm:text-3xl pt-12 sm:pt-0">Shop Collection</h3>
      <div className="my-7 min-h-screen font-tec grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 ">
