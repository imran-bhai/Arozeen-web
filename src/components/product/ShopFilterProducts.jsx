...
const filters = [
  {
    ...
    options: [
      ...
      { value: "lamp", label: "Lamp", checked: true },
...
export default function ShopFilterProducts() {
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <div className=" flex space-x-64 items-center">
              ...
              <h3 className="text-xl font-semibold">Shop / New Arrivals</h3>
            </div>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className=" flex gap-x-12">
              {/* Filters */}
              <form className="hidden lg:block lg:basis-2/7">
                <h3 className="sr-only">Categories</h3>
